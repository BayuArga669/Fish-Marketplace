...
<head>
    ...
    <title>{{ $title ?? 'Pasar Ikan Online' }}</title>
   ...
   <nav class="navbar navbar-expand-lg navbar-dark bg-primary">
    ...
    <footer class="bg-dark text-light py-4 mt-5">
        <div class="container">
            <div class="row">
                <div class="col-md-6">
                    <h5>Pasar Ikan Online</h5>
                    <p>Platform jual beli ikan segar terpercaya</p>
                </div>
                <div class="col-md-6 text-md-end">
                    <p>&copy; {{ date('Y') }} Pasar Ikan Online. All rights reserved.</p>
                </div>
            </div>
        </div>
    </footer>
